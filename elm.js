...
var $author$project$Game$ModeExercise$ModesFetched = function (a) {
	return {$: 'ModesFetched', a: a};
};
...
var $author$project$Game$ModeExercise$Modes = F7(
	function (ionian, dorian, phrygian, lydian, mixolydian, aeolian, locrian) {
		return {aeolian: aeolian, dorian: dorian, ionian: ionian, locrian: locrian, lydian: lydian, mixolydian: mixolydian, phrygian: phrygian};
	});
var $elm$json$Json$Decode$map7 = _Json_map7;
var $author$project$Game$ModeExercise$modeDecoder = A8(
	$elm$json$Json$Decode$map7,
	$author$project$Game$ModeExercise$Modes,
	A2(
		$elm$json$Json$Decode$field,
		'ionian',
	...
	A2(
		...
		'locrian',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$int)));
var $author$project$Game$ModeExercise$fetchModes = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Game$ModeExercise$ModesFetched, $author$project$Game$ModeExercise$modeDecoder),
		url: ' http://localhost:5019/modes'
	});
var $author$project$Game$ModeExercise$init = function (_v0) {
	return _Utils_Tuple2(
		{modes: $elm$core$Maybe$Nothing, value: ''},
		$author$project$Game$ModeExercise$fetchModes);
};
var $elm$core$Set$Set_elm_builtin = function (a) {
	return {$: 'Set_elm_builtin', a: a};
};
var $elm$core$Set$empty = $elm$core$Set$Set_elm_builtin($elm$core$Dict$empty);
var $author$project$Game$NoteExercise$ScalesFetched = function (a) {
	return {$: 'ScalesFetched', a: a};
};
var $author$project$Game$NoteExercise$Scale = F2(
	function (key, notes) {
...
var $author$project$Game$NoteExercise$scaleDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Game$NoteExercise$Scale,
	...
	A2(
		...
		A2(
			...
			'notes',
			$elm$json$Json$Decode$list($elm$json$Json$Decode$string))));
var $author$project$Game$NoteExercise$fetchScales = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$Game$NoteExercise$ScalesFetched,
			$elm$json$Json$Decode$list($author$project$Game$NoteExercise$scaleDecoder)),
		url: 'http://localhost:5019/scales'
	});
var $elm$core$Debug$log = _Debug_log;
var $author$project$Game$NoteExercise$init = function (flags) {
	var _v0 = A2($elm$core$Debug$log, 'flags', flags);
	return _Utils_Tuple2(
		{
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[$author$project$Game$NoteExercise$fetchScales])));
};
		...
		if (msg.a.$ === 'Ok') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						modes: $elm$core$Maybe$Just(modes)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var error = msg.a.a;
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$elm$core$Task$perform,
						function (_v0) {
							return $author$project$Game$NoteExercise$Reset(true);
						},
...
var $author$project$Game$NoteExercise$gameOver = A2(
	$elm$core$Task$perform,
	function (_v0) {
...
var $author$project$Game$NoteExercise$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (_v2.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								chosenScale: $elm$core$Maybe$Just(newScale)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'FetchScales':
				return _Utils_Tuple2(model, $author$project$Game$NoteExercise$fetchScales);
			case 'ScalesFetched':
				if (msg.a.$ === 'Ok') {
					var scales = msg.a.a;
					return _Utils_Tuple2(
			...
			case 'ChooseKey':
				...
				var newModel = _Utils_Tuple2(
					_Utils_update(
						model,
						{
							chosenScale: $elm$core$Maybe$Just(scale),
							correctPairs: $elm$core$Set$empty,
							noteClicked: '',
							noteIndex: 7,
							numberIndex: 7
...
var $author$project$Game$ModeExercise$viewModes = function (modes) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				$elm$core$Debug$toString(modes.aeolian))
			]));
};
var $author$project$Game$ModeExercise$viewModesOrError = function (maybeModes) {
	if (maybeModes.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Game$ModeExercise$viewModes(modes)
				]));
	} else {
...
var $author$project$Game$ModeExercise$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Game$ModeExercise$viewModesOrError(model.modes)
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Game$NoteExercise$GameOver),
...
var $author$project$Game$NoteExercise$viewKeys = function (scale) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onClick(
				$author$project$Game$NoteExercise$ChooseKey(scale))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(scale.key)
			]));
};
...
var $author$project$Game$NoteExercise$NoteClicked = function (a) {
	return {$: 'NoteClicked', a: a};
};
var $author$project$Game$NoteExercise$isNoteCorrect = F2(
...
var $author$project$Game$NoteExercise$viewScaleButtons = F2(
	function (model, _v0) {
		...
		var note = _v0.b;
		var isActive = _Utils_eq(model.noteIndex, originalIndex);
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					function (key) {
						return $author$project$Game$NoteExercise$viewKeys(key);
					},
					model.scales)),
				function () {
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$core$List$map,
									function (note) {
										return A2($author$project$Game$NoteExercise$viewScaleButtons, model, note);
									},
									scale.notes)),
								A2(
								$elm$html$Html$div,
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$string)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Game.ModeExercise.Modes":{"args":[],"type":"{ ionian : List.List Basics.Int, dorian : List.List Basics.Int, phrygian : List.List Basics.Int, lydian : List.List Basics.Int, mixolydian : List.List Basics.Int, aeolian : List.List Basics.Int, locrian : List.List Basics.Int }"},"Game.NoteExercise.Note":{"args":[],"type":"String.String"},"Game.NoteExercise.Scale":{"args":[],"type":"{ key : String.String, notes : List.List ( Basics.Int, Game.NoteExercise.Note ) }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UrlChanged":["Url.Url"],"LinkClicked":["Browser.UrlRequest"],"NoteExerciseMsg":["Game.NoteExercise.Msg"],"ModeExerciseMsg":["Game.ModeExercise.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Game.ModeExercise.Msg":{"args":[],"tags":{"ModesFetched":["Result.Result Http.Error Game.ModeExercise.Modes"]}},"Game.NoteExercise.Msg":{"args":[],"tags":{"NoteClicked":["Basics.Int"],"NumberClicked":["Basics.Int"],"Shuffle":[],"Shuffled":["List.List ( Basics.Int, Game.NoteExercise.Note )"],"FetchScales":[],"ScalesFetched":["Result.Result Http.Error (List.List Game.NoteExercise.Scale)"],"ChooseKey":["Game.NoteExercise.Scale"],"Reset":["Basics.Bool"],"GameOver":[],"ClearWrongPairs":[],"FlashWrong":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}}}})}});}(this));